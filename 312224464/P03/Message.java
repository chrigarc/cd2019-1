...
public class Message{
    ...
    private LinkedList<String> recorrido;//Cambiamos el recorrido de Object a una Linkedlist
    ...
    public Message(String source, String destination, Serializable content){
        ...
        this.recorrido.add(source);//Agregamos el nodo inicial al recorrido.
        this.recorrido.add(destination); //agregamos el nodo final al recorrido.
    }
    ...
    //Método que regresa el recorrido de tipo LinkedList
    public LinkedList<String> getRecorrido(){
        return this.recorrido;
    }

    //agregamos el método setRecorrido
