...
public class MainApp extends Frame{
	...
	private void updateView(Graphics2D g2){
	...
	public class MouseEventListener extends MouseAdapter {
		...
		public void mouseWheelMoved(MouseWheelEvent e) {
			...
			updateView((Graphics2D)e.getComponent().getGraphics());
	...
	public MainApp() throws Exception{
		...
		do {
			...
			updateView((Graphics2D) this.getGraphics());
                        //statistics
                        ...
                        for(Integer id : idxs.keySet()){
                            if(stats.containsKey(id)){
                                ...
                                stats.put(id, new ArrayList(idxs.get(id)));
                            }
                        }
			Thread.sleep(200);
        ...
        void print_populatios(Map<Integer,List<Integer>> stats) throws Exception {
            File file = new File("/ada.fciencias.unam.mx/alumnos/chrigarc/Downloads/glade/src/main/java/main/test.dat");
